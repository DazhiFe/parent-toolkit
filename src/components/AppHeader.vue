  ...
  <header class="bg-white dark:bg-gray-800 shadow-sm fixed top-0 left-0 right-0 z-50">
    ...
    <div v-show="isMenuOpen" class="md:hidden bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="https://mcn4hqasxwno.feishu.cn/wiki/VdLTwOdqmiJEg9kzY07cjtYTnxd?from=from_copylink" target="_blank" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">老魏的咖啡馆</a>
