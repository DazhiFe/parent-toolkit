...
export const aiTools = [
  ...
  { id: 'aibot', name: 'AI Bot', url: 'https://aibot.cn',
    description: '国内老牌AI工具导航站，工具收录全面',
    category: 'news', color: 'blue', letter: 'A' },
  ...
  { id: 'yige', name: '文心一格', url: 'https://yige.baidu.com',
    description: '百度AI作画，国内主流绘画工具',
    category: 'image', color: 'blue', letter: '格' },
  ...
  { id: 'suno', name: 'Suno', url: 'https://suno.com',
    description: '全球最火AI音乐生成，输入歌词自动生成完整歌曲',
    category: 'audio', color: 'purple', letter: 'S', tag: '热门' },
